...
export const skuCategories = pgTable('sku_categories', {
    ...
    parentId: uuid('parent_id').references(() => skuCategories.id),
...
export const skus = pgTable('skus', {
    ...
    index('idx_skus_fts').using('gin', sql `to_tsvector('english', ${table.skuCode} || ' ' || ${table.name} || ' ' || COALESCE(${table.description}, ''))`),
